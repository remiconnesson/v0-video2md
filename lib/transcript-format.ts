...
/**
 * Formats transcript segments into a string suitable for LLM analysis with padded timestamps.
 * Each segment is prefixed with its timestamp using HH:MM:SS format.
 *
 * @param segments - Array of transcript segments
